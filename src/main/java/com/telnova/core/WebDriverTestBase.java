...
import com.telnova.util.PropertiesCache;
...
public class WebDriverTestBase {
    ...
    @BeforeClass
    public void setUp() {
       // System.setProperty("webdriver.chrome.driver", "C:\\Users\\Mir\\Desktop\\atola\\chromedriver.exe"); //название системной переменной
        setBrowser();
